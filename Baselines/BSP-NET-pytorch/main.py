...
parser.add_argument("--threshold", action="store", dest="threshold", default=0.1, type=float, help="Threshold for model float [0.0001]")
...
parser.add_argument("--sample_vox_size", action="store", dest="sample_vox_size", default=64, type=int, help="Voxel resoluti on for coarse-to-fine training [64]")
